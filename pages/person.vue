<template>
  <view>
    <view class="person-head">
			<view class="cmd-avatar cmd-avatar-lg" style="background-color: #fff;border-radius: 50%;">
				<image class="cmd-avatar-img" src="https://avatar.bbs.miui.com/images/noavatar_small.gif"></image>
			</view>
      <view class="person-head-box">
        <view class="person-head-nickname">昵称</view>
        <view class="person-head-username">手机号：slimmer9501</view>
				<view class="person-head-username">微信：slimmer9501</view>
      </view>
    </view>
    <view class="person-list">
      ...
      <cmd-cell-item title="消息通知" slot-left arrow>
        <cmd-icon type="message" size="24" color="#368dff"></cmd-icon>
			...
			<view class="cmd-cell-item" hover-class="cmd-cell-item-hover">
				<view class="cmd-cell-item-body">
					<view class="cmd-cell-item-left">
						<view class="cmd-icon cmd-icon-message" style="color:#368dff;font-size:24px;line-height:24px"></view>
					</view>
					<view class="cmd-cell-item-content">
						<view class="cmd-cell-item-title">消息通知</view>
					</view>
				</view>
			</view>
			<view class="cmd-cell-item" hover-class="cmd-cell-item-hover">
